...
var service = {
  ...
  n: function () {
    ...
    if (arguments.length > 1) {
      ...
      message = chalk.green(chalk.bgBlack(message))
    }
    else {
      message = arguments[0]
    }
    require("fs").appendFile(`${logdir}${session}`, `${tag} (${service.location}): ${message}`, {encoding: "utf8"})
  },
    ...
    if (parts.length >= 3) {
      ...
      if (tag) {
        ...
        if (tooLong) {
          ...
          result = "\x1b[38;5;34m" + result + "\x1b[0m"
        }
